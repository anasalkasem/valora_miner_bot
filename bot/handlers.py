...
def register_handlers(dp: Dispatcher):
    ...
    async def start_command(message: Message):
        ...
        referral_id = int(args) if args.isdigit() else None
    ...
    @dp.message_handler(lambda message: message.text == "📊 نقاطي")
    ...
    @dp.message_handler(lambda message: message.text == "🤝 دعوة صديق")
